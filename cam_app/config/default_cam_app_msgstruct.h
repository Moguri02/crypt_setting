 ...
 *   are defined in cam_app_msgdefs.h.
 */
#ifndef CAM_APP_MSGSTRUCT_H
#define CAM_APP_MSGSTRUCT_H
...
{
    CFE_MSG_CommandHeader_t CommandHeader; /**< \brief Command header */
} CAM_APP_ResetCountersCmd_t;

typedef struct
{
    CFE_MSG_CommandHeader_t CommandHeader; /**< \brief Command header */
} CAM_APP_ProcessCmd_t;
...
typedef struct
{
    ...
    CAM_APP_HkTlm_Payload_t Payload;         /**< \brief Telemetry payload */
} CAM_APP_HkTlm_t;

#endif /* CAM_APP_MSGSTRUCT_H */
